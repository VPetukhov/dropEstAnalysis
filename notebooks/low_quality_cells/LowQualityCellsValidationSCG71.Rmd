...
clusters_annotated_resc <- AnnotateClusters(r_rescued$graphs$PCA, clusters, notannotated_cells,
...
gg_tsne <- PlotFiltrationResults(r_rescued, clusters[names(clusters) %>% setdiff(rescued_cbs) %>% setdiff(filtered_cbs)],

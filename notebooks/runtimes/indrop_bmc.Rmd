---
title: "Runtimes for the inDrop BMCs dataset"
...
tag_stats <- readRDS(paste0(kEstDataPath, '../tag_2018_03_15/SCG_71_C2_S2_R1_001.fastq.gz.tagged.rds'))
```
...
### Quality scoring
```{r, warning=FALSE}
times_quality <- sapply(1:10, function(i) TimeQuality(holder, mit.chromosome.name='chrM', tags.data=tag_stats))
print(times_quality)

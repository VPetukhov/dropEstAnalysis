...
gg_annotation <- PlotClustering(pgd, clusters_annotated) + theme_pdf()
gg_annotation
```
...
```{r, message=FALSE, warning=FALSE}
plot_genes <- c('Mmp9', 'Srgn', 'Cxcr2', 'Cd7', 'Cd34', 'Lyz1', 'Vpreb3', 'Cd22', 'Nkg7')
plot_borders <- lapply(c("l", "l", "l", "b", "b", "b", "r", "r", "r"), 
